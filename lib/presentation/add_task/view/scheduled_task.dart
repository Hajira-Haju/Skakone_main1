...
import '../../my_task_screen/controller/my_task_controller.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              AddTaskWidgets.buildLabel('Start Date'),
              Obx(
                    () => GestureDetector(
              ...
              AddTaskWidgets.buildLabel('End Date'),
              Obx(
                    () => GestureDetector(
              ...
              AddTaskWidgets.buildLabel('No. of Occurrences'),
              AddTaskWidgets.buildInputField(
                controller.noOfOccurrencesController,
                'Enter Interval',
              ),
