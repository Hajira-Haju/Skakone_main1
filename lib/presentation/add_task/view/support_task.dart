...
class SupportTaskScreen extends StatelessWidget {
  final AddTaskController controller = Get.put(AddTaskController());
  SupportTaskScreen({super.key});
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              AddTaskWidgets.buildLabel('Reported By'),
              AddTaskWidgets.buildInputField(
              ...
              Obx(
                () => AddTaskWidgets.buildCheckboxes(
                  repeatedIncident: controller.isRepeatedIncident.value,
                  systemDown: controller.isSystemDown.value,
                  onRepeatedChanged:
                      (val) =>
                          controller.isRepeatedIncident.value = val ?? false,
                  onSystemDownChanged:
                      (val) => controller.isSystemDown.value = val ?? false,
                ),
              ),
